...
const MainLayout: React.FC<MainLayoutProps> = ({ children }) => {
  ...
  const navigation = [
    ...
    { 
      name: 'Prospectos', 
      href: '/prospects', 
      current: location.pathname.startsWith('/prospects'),
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-between h-16 px-6 border-b border-gray-200 dark:border-gray-700">
            <div className="flex items-center">
              ...
              <h1 className="text-lg font-semibold text-gray-900 dark:text-white">CExCIE</h1>
            </div>
            <button
            ...
            {navigation.map((item) => (
              <Link
                ...
                className={clsx(
                  ...
                  item.current
                    ? 'bg-primary-50 text-primary-700 border-r-2 border-primary-500 dark:bg-primary-900/50 dark:text-primary-300 dark:border-primary-400'
      ...
      <div className="lg:pl-64">
        ...
        <div className="lg:hidden bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-4 py-3">
          <div className="flex items-center justify-between">
            ...
            <h1 className="text-lg font-semibold text-gray-900 dark:text-white">CExCIE Dashboard</h1>
